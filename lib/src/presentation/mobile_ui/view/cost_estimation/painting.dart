...
class _PaintingState extends State<Painting> {
  ...
  String limeRateType = "default";
  String gumRateType = "default";
  List values = [
    "2 Coat White Wasahing in Ceiling",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(context,"Painting Works"),
      body: Stack(
        children: [
          ListView(
        ...
        Container(
          ...
          child: DropdownFormField<Map<String, dynamic>>(
            ...
            ListTile(
              ...
              onTap: (){
                onTap();
                for(int i = 0; i <paintingRate.length; i++){
                  if(paintingRate[i]["name"] == item['label']){
                    setState(() {
                      labourCon.text = paintingRate[i]["labourPrice"].toString();
                      labour  = paintingRate[i]["labourPrice"].toString();
                      skilledLabourCon.text  = paintingRate[i]["skilledLabourPrice"].toString();
                      skilledLabour  = paintingRate[i]["skilledLabourPrice"].toString();
                      lime  = paintingRate[i]["lime"].toString();
                      limeCon.text  = paintingRate[i]["lime"].toString();
                      gum = paintingRate[i]["gum"].toString();
                      gumCon.text  = paintingRate[i]["gum"].toString();
                    });
                  }
                }
              }
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Lime", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per Kg)', style: roboto(black, 10.5, 0.0),)
                ],
              )
            ),
            CustomTextField(
              textController: limeCon,
              isReadable: limeRateType == "default" ? true : false,
              readOnly: limeRateType == "default" ? true : false,
              keyboardType: TextInputType.number,
              textFieldWidth: 108.0.w,
              textfieldHeight: 45.0.h,
              prefixIcon: Text("रु", style: roboto(const Color.fromARGB(255, 153, 153, 153), 18.5, 0.0),),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: limeRateType == "default" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                      ),
                      child: Center(
                        child: Text("Default", 
                          style: limeRateType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: limeRateType == "custom" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                        ),
                      child: Center(
                        child: Text("Custom", 
                          style: limeRateType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Gum", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per Kg)', style: roboto(black, 10.5, 0.0),)
                ],
              )
            ...
            CustomTextField(
              ...
              isReadable: gumRateType == "default" ? true : false,
              readOnly: gumRateType == "default" ? true : false,
              keyboardType: TextInputType.number,
              textFieldWidth: 108.0.w,
              textfieldHeight: 45.0.h,
              prefixIcon: Text("रु", style: roboto(const Color.fromARGB(255, 153, 153, 153), 18.5, 0.0),),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: gumRateType == "default" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                      ),
                      child: Center(
                        child: Text("Default", 
                          style: gumRateType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: gumRateType == "custom" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                        ),
                      child: Center(
                        child: Text("Custom", 
                          style: gumRateType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
  ...
  calculate(){
    ...
    setState(() {
      ...
      totalCost = length * breadth + double.parse(labourCon.text) + double.parse(skilledLabourCon.text) + double.parse(limeCon.text) + double.parse(gumCon.text);
      ...
      resultDetailsList.addAll(
        [
          ...
          {
            "itemName" : "Skilled Lb.",
            "quantity" : "3% of Labour",
            "cost" : "रु  ${(double.parse(skilledLabourCon.text) * 0.03).toStringAsFixed(2)}"
          },
          {
            "itemName" : "Lime",
            "quantity" : "2 per kg",
            "cost" : "रु  ${(double.parse(limeCon.text)).toStringAsFixed(2)}"
          },
          {
            "itemName" : "Gum",
            "quantity" : "1 per kg",
            "cost" : "रु  ${(double.parse(gumCon.text)).toStringAsFixed(2)}"
          }
        ]
      );
    });
