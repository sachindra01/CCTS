...
class PlumbingWorks extends StatefulWidget {
  const PlumbingWorks({super.key});

  @override
  State<PlumbingWorks> createState() => _PlumbingWorksState();
}

class _PlumbingWorksState extends State<PlumbingWorks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(context, "Plumbing Works"),
      body: Stack(
        children: [
  ...
  quantity() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Quantity".toUpperCase(), style: roboto(darkBlack, 16.0, 0.0),),
        SizedBox(height: 25.0.h,),
        CustomTextField(
          ...
          suffixIcon: Text("units", style: roboto(const Color.fromARGB(255, 153, 153, 153), 14.0, 0.0),),
  ...
  selectItem() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Items".toUpperCase(), style: roboto(darkBlack, 16.0, 0.0),),
        SizedBox(height: 25.0.h,),
        CustomTextField(
          ontap: (){
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Plumber", style: roboto(black, 15, 0.0),),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: plumberType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: plumberType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Helper", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per Person)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: helperType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: helperType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Commode", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
            ),
            CustomTextField(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: commodeType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: commodeType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("PVC Pipe", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),),
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: pvcPipeType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: pvcPipeType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Connector", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: connectorType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: connectorType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Angle Valve", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: angleValveType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: angleValveType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Auto Flush", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: autoFlushType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: autoFlushType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Cistern", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: cisternType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: cisternType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Misc", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per piece)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: miscType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: miscType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text("Items",style: roboto(black, 15, 0.0),),
            Text("Quantity",style: roboto(black, 15, 0.0),),
            Text("Cost",style: roboto(black, 15, 0.0),)
          ],
        ),
        SizedBox(height: 18.0.h,),
        Divider(
        ...
        Row(
          ...
          children: [
            ...
            Flexible(
              child: Text(
                "रु 0.00",
                style: roboto(black, 20, 0.0, FontWeight.w600),
              ),
            ),
          ],
        ),
