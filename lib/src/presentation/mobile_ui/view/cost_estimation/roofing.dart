...
class Roofing extends StatefulWidget {
  const Roofing({super.key});

  @override
  State<Roofing> createState() => _RoofingState();
}

class _RoofingState extends State<Roofing> {
  //Custom and default Flags
  String selectUnit = "meter";
  String rateType = "default";
  String labourType = "default";
  String skilledLabourType = "default";
  String cgiSheetsType = "default";
  ...
  final cgiSheetsCon = TextEditingController();
  ...
  void initState() {
    ...
    cgiSheetsCon.text = cgiSheets;
    nutBoltCon.text = nutBolt;
    jHookCon.text = jHook;
    washerCon.text = washer;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(context, "Roofing"),
      body: Stack(
        children: [
          ListView(
        ...
        Container(
          ...
          child: DropdownFormField<Map<String, dynamic>>(
            ...
            ListTile(
              ...
              onTap: (){
                onTap();
                for(int i = 0; i < roofingRate.length; i++){
                  if(roofingRate[i]["name"] == item['label']){
                    setState(() {
                      labourCon.text = roofingRate[i]["labourPrice"].toString();
                      labour  = roofingRate[i]["labourPrice"].toString();
                      skilledLabourCon.text  = roofingRate[i]["skilledLabourPrice"].toString();
                      skilledLabour  = roofingRate[i]["skilledLabourPrice"].toString();
                      cgiSheetsCon.text  = roofingRate[i]["cgiSheets"].toString();
                      cgiSheets  = roofingRate[i]["cgiSheets"].toString();
                      nutBoltCon.text  = roofingRate[i]["nutbolt"].toString();
                      nutBolt  = roofingRate[i]["nutbolt"].toString();
                      jHook  = roofingRate[i]["jhook"].toString();
                      jHookCon.text  = roofingRate[i]["jhook"].toString();
                      washer  = roofingRate[i]["washer"].toString();
                      washerCon.text  = roofingRate[i]["washer"].toString();
                    });
                  }
                }
              }
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("CGI sheets", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per sq.m.)', style: roboto(black, 10.5, 0.0),)
                ],
              )
            ),
            CustomTextField(
              textController: cgiSheetsCon,
              isReadable: cgiSheetsType == "default" ? true : false,
              keyboardType: TextInputType.number,
              readOnly: cgiSheetsType == "default" ? true : false,
              textFieldWidth: 108.0.w,
              textfieldHeight: 45.0.h,
              prefixIcon: Text("रु", style: roboto(const Color.fromARGB(255, 153, 153, 153), 17.0, 0.0),),
              hintTextSize: 14.0.sp,
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: cgiSheetsType == "default" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                      ),
                      child: Center(
                        child: Text("Default", 
                          style: cgiSheetsType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    onTap: (){
                      setState(() {
                        cgiSheetsType = "custom";
                      });
                    },
                    child: Container(
                      width: 51.5.w,
                      decoration: BoxDecoration(
                        color: cgiSheetsType == "custom" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                        ),
                      child: Center(
                        child: Text("Custom", 
                          style: cgiSheetsType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Nut Bolt", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: nutBoltType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: nutBoltType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("J-Hook", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per Unit)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: jHookType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: jHookType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Washer", style: roboto(black, 15, 0.0),),
                  SizedBox(height: 2.0.h,),
                  Text('(Per Unit)', style: roboto(black, 10.5, 0.0),)
                ],
              )
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Default", 
                          style: washerType == "default" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Custom", 
                          style: washerType == "custom" ? roboto(white, 11.0, 0.0) : roboto(black, 11.0, 0.0),
                        )
                      )
                    ),
                  ),
  ...
  calculate(){
    ...
    setState(() {
      ...
      totalCost = length * breadth + double.parse(labourCon.text) + double.parse(skilledLabourCon.text) + double.parse(cgiSheetsCon.text) + double.parse(nutBoltCon.text) + double.parse(jHookCon.text);
      ...
      resultDetailsList.addAll(
        [
          ...
          {
            "itemName" : "CGI sheets",
            "quantity" : "1.5 per sq.m",
            "cost" : "रु  ${double.parse(cgiSheetsCon.text).toStringAsFixed(2)}"
          },
          {
            "itemName" : "Nut Bolt",
            "quantity" : "15 per unit",
            "cost" : "रु  ${double.parse(nutBoltCon.text).toStringAsFixed(2)}"
          },
          {
            "itemName" : "J-Hook",
            "quantity" : "20 per unit",
            "cost" : "रु  ${double.parse(jHookCon.text).toStringAsFixed(2)}"
          },
          {
            "itemName" : "Washer",
            "quantity" : "2 per unit",
            "cost" : "रु  ${double.parse(washerCon.text).toStringAsFixed(2)}"
          },
        ]
      );
    });
