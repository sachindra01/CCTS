...
class LandConverterWidget extends StatelessWidget {
  ...
  final String? hintText, suffix;
  final double? height, width;
  final bool? readonly;
  const LandConverterWidget({super.key, this.textController, this.onChange,  required this.hintText, this.onTap, this.height, this.width, this.readonly, this.suffix, });
