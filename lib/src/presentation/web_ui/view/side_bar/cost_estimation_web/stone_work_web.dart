...
class StoneCalculationWeb extends StatefulWidget {
  const StoneCalculationWeb({super.key});

  @override
  State<StoneCalculationWeb> createState() => _StoneCalculationWebState();
}

class _StoneCalculationWebState extends State<StoneCalculationWeb> {
  String selectUnit = "meter";
  String rateType = "default";
  String labourType = "default";
  String skilledLabourType = "default";
  String stoneType = "default";
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Stone", style: roboto(black, 13, 0.0),),
            ...
            CustomTextFieldWeb(
              ...
              keyboardType: TextInputType.number,
              readOnly: stoneType == "default" ? true : false,
              isReadable: stoneType == "default" ? true : false,
              textFieldWidth: 74,
              textfieldHeight: 28.0,
              contentTopPadding: -3.5,
              prefixIcon: Text("रु", style: roboto(const Color.fromARGB(255, 153, 153, 153), 17.0, 0.0),),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      width: 40,
                      decoration: BoxDecoration(
                        color: stoneType == "default" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                      ),
                      child: Center(
                        child: Text("Default", 
                          style: stoneType == "default" ? roboto(white, 10.0, 0.0) : roboto(black, 10.0, 0.0),
                        )
                      )
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      width: 40,
                      decoration: BoxDecoration(
                        color: stoneType == "custom" ? violet.withOpacity(0.8) : white,
                        borderRadius: BorderRadius.all(Radius.circular(20.0.r))
                        ),
                      child: Center(
                        child: Text("Custom", 
                          style: stoneType == "custom" ? roboto(white, 10.0, 0.0) : roboto(black, 10.0, 0.0),
                        )
                      )
                    ),
                  ),
